...
var tree_data = {
	'systems-management' : {name: '系统管理', type: 'folder'}	,
	'information-management' : {name: '信息管理', type: 'folder'}	
	}
tree_data['systems-management']['additionalParameters'] = {
	'children' : {
		'organization' : {name: '组织管理', type: 'item'},
		'user' : {name: '系统用户', type: 'item'},
		'member' : {name: '会员管理', type: 'item'}
